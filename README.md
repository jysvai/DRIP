...
날씨는 맑음·흐림·비·폭우·짙은 안개 중에서 고른다. 비·안개에는 법정 감속(젖은 노면 20%, 가시거리 100m 이내 50%)으로 판정하고, 젖은 노면은 제동거리가 약 1.8배로 늘어난다 (`game/DATA.md`). 운전석 시점에서는 앞유리에 빗방울이 맺히고(빠를수록 많이, 큰 방울은 맞바람에 위로), 와이퍼가 비에는 간헐·폭우에는 빠르게 닦는다. 달리는 차는 뒷바퀴로 물보라를 튀기고(트럭·버스는 더 크고 짙게), 앞차 물보라에 앞이 뿌예진다. 밤에 비가 오면 전조등·미등이 젖은 노면에 길게 비친다.
